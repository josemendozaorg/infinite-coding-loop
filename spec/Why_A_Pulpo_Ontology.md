...
*   **The Engine (Mechanism):** The Rust code (`pulpo-engine`) is agnostic to the domain. It focuses on graph traversal, CLI tool invocation, and template rendering. It does not need to know what a "Feature" or a "Risk" is implies.
